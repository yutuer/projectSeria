...
public class RequestWrapperHandler extends SimpleChannelInboundHandler<BaseReqProtocal.BaseReq> {
	...
	private RequestAPIMap requestAPIMap = (RequestAPIMap) SpringContextUtil
			.getBean(RequestAPIMap.class.getSimpleName());
	...
	@Override
	protected void channelRead0(ChannelHandlerContext ctx, BaseReq baseReq) throws Exception {
